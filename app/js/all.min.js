...
;(function () {
    ...
    var myslider = function SliderClass() {
        ...
        var slider = document.querySelector(o.sliderr);
        var slides = document.querySelectorAll(o.slidess);
        var dots = document.querySelectorAll(o.dotActiveClass);
        var curSlide = 0;
        ...
        function createDots() {
            var dotConteiner = document.querySelector(o.dotActiveClass);
    ...
    (function () {
        ...
        fone.addEventListener('click', function (event) {
            hidenA();
            resetInput();
        });
    ...
    (function () {
        var pop = document.getElementById('midly'),
